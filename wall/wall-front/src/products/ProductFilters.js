...
class ProductFilters extends React.Component {
    ...
    onMinYearChange(e) {
        e.preventDefault();
        let proYearLte = e.target.value;
        this.setState({proYearLte})
    }

    onMaxYearChange(e) {
        e.preventDefault();
        let proYearGte = e.target.value;
        this.setState({proYearGte})
    }
                                        ...
                                        <DropdownMenu>
                                                ...
                                                onClick={this.onCategoryChange.bind(this, '', '----')}>----</DropdownItem>
                                            {
                                                Object.keys(Category).map(category =>
                                                    <DropdownItem key={Category[category].key}
                                                                  onClick={this.onCategoryChange.bind(this, Category[category].key, Category[category].value)}>
